...
from evaluation.server_replayer import verify_formula_as_compliant, verify_with_data, verify_formula_ivan
...
def run_experiments(log_name, models_folder, fold):
    ...
    with open(output_filename, 'w') as csvfile:
        ...
        spamwriter.writerow(["Prefix length",
                             ...
                             "Ground Truth Group",
                             "Predicted Group",
                             "Damerau-Levenshtein Resource", "compliantness"])
                ...
                for i in range(predict_size):
                    for k in range(current_beam_size):
                        ...
                        if not found_satisfying_constraint:
                            ...
                            if verify_formula_ivan(current_prediction_premis.trace_id, current_prediction_premis.cropped_line, declare_model_filename, current_prediction_premis.cropped_line_group, "declare"):
