...
from evaluation.prepare_data import prepare_testing_data, select_petrinet_verified_traces, amplify, get_symbol_ampl, \
    encode
...
def run_experiments(log_name, models_folder, fold):
    ...
    with open(output_filename, 'w') as csvfile:
        ...
        for prefix_size in range(prefix_size_pred_from, prefix_size_pred_to):
            ...
            counter = 0
            for line, line_id, outcome in zip(lines_s, lines_id_s, lines_o_s):
                ...
                current_beam_size = shared_variables.beam_size
