...
def run_experiments(log_name, models_folder, fold):
    ...
    lines, lines_id, lines_group, lines_time, lines_t, lines_t2, lines_t3, lines_t4, maxlen, chars, chars_group, \
        chars_time, char_indices, char_indices_group, char_indices_time, divisor, divisor2, divisor3, predict_size, \
        target_indices_char, target_indices_char_group, target_indices_char_time, target_char_indices, \
        target_char_indices_group, target_char_indices_time = prepare_testing_data(log_name)
    ...
    output_filename = folder_path / (log_name + '_CFRT.csv')
    ...
    with open(output_filename, 'w') as csvfile:
        ...
        for prefix_size in range(prefix_size_pred_from, prefix_size_pred_to):
            ...
            lines_s, lines_id_s, lines_group_s, lines_time_s, lines_t_s, lines_t2_s, lines_t3_s, lines_t4_s \
                = select_declare_verified_traces(log_name, lines, lines_id, lines_group, lines_time, lines_t, lines_t2,
                                                 lines_t3, lines_t4,  pn_model_filename, prefix_size)

            print("formulas verified: " + str(len(lines_s)) + " out of : " + str(len(lines)))
            pt_array = []
            for line, line_id, line_group, line_time, times, times2, times3, times4 \
                    in zip(lines_s, lines_id_s, lines_group_s, lines_time_s, lines_t_s, lines_t2_s, lines_t3_s,
                           lines_t4_s):
                times.append(0)
